...
old = """**trade_summary** — PRE-COMPUTED trade analytics. Use this for ANY trade question. One row per trade.
...
new = """**trade_summary** — PRE-COMPUTED trade analytics. Use this for ANY trade question. One row per trade.
  transaction_key, season, trade_date, trade_week,
  trader_nickname, tradee_nickname,
